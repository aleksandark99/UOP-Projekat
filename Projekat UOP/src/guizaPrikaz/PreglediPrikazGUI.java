...
public class PreglediPrikazGUI extends JFrame {
	...
	private void PregledGUI() {
		...
		String[] zaglavlje = new String[] {"Ime pacijenta","Prezime pacijenta", "Ime Lekara","Prezime lekara","Termin","Soba","Opis","Racun","Status","Broj"};	
		...
		for(int i=0; i<pregledActive.size(); i++) {
			...
			podaci[i][8] = pregled.getStatus() ;
			podaci[i][9] = pregled.getBroj();
